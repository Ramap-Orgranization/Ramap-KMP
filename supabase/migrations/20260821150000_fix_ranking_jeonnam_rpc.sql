...
drop function if exists public.fetch_shop_rankings(text, text, text[], bigint, text, uuid, integer);
drop function if exists public.fetch_ranking_sigungu(text);
...
grant execute on function public.fetch_shop_rankings(text, text, text[], bigint, text, uuid, integer)
    to anon, authenticated;
grant execute on function public.fetch_ranking_sigungu(text)
    to anon, authenticated;
